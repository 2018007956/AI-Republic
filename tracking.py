...
class Tracker:
        ...
        def clock(self, objectID):
                ...
                deregister_time -= 60  # 50 frame : almost 70 sec -> 이 차이는 영상이 어떻게 생겼는지에 따라 다 다르므로 가게 test영상 받으면 정확히 맞춰줌
        ...
        def update(self, rects,num):
                ...
                if len(self.objects) == 0:
                        ...
                        # # D.shape[0] : objectCentroids 수(tracking하는 수) / D.shape[1] : detecting하는 수
                        # # 같으면 새로들어오는 object없이 있는걸로 object detecting하는 중
